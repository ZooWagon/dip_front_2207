      ...
      <el-row>
        <el-col :span="12">
          <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
            <el-form-item label="第一个点原坐标：">
              <el-input v-model="paraPacket.para1"></el-input>
            </el-form-item>
            <el-form-item label="第二个点原坐标：">
              <el-input v-model="paraPacket.para2"></el-input>
            </el-form-item>
            <el-form-item label="第三个点原坐标：">
              <el-input v-model="paraPacket.para3"></el-input>
            </el-form-item>
          </el-form>
        </el-col>
        <el-col :span="12">
          <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
            <el-form-item label="第一个点新坐标：">
              <el-input v-model="paraPacket.para4"></el-input>
            </el-form-item>
            <el-form-item label="第二个点新坐标：">
              <el-input v-model="paraPacket.para5"></el-input>
            </el-form-item>
            <el-form-item label="第三个点新坐标：">
              <el-input v-model="paraPacket.para6"></el-input>
            </el-form-item>
          </el-form>
        </el-col>
      </el-row>
...
export default {
  ...
  data(){
    return{
      paraPacket: {
        ...
        stype: '3026',
        img1: 'img1', img2: '',
        para1: '0,0', para2: '0,10', para3: '10,0',
        para4: '0,0', para5: '5,20', para6: '20,5',
        para7: '', para8: '',
        status: '处理中'
      },
  ...
  methods: {
    ...
    async post_para() {
      ...
      // post parameter
      await this.$axios
          .post('/warp_affine',this.paraPacket)
          .then((res) => {
            console.log(res)
