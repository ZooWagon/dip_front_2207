  ...
  <div class="clock">
    ...
    <div>
      <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
        ...
        <el-form-item label="翻转类型：">
          <el-select v-model="paraPacket.para1" placeholder="请选择翻转类型">
            <el-option label="水平镜像" value="1"></el-option>
            <el-option label="垂直镜像" value="0"></el-option>
            <el-option label="对角镜像" value="-1"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
      <div align="center">
...
export default {
  ...
  methods: {
    ...
    async post_para() {
      ...
      // post parameter
      await this.$axios
          .post('/mirror_flip',this.paraPacket)
          .then((res) => {
            console.log(res)
