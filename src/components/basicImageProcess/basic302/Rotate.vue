  ...
  <div class="clock">
    ...
    <div>
      <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
        ...
        <el-form-item label="旋转中心坐标：">
          <el-input v-model="paraPacket.para1"></el-input>
        </el-form-item>
        <el-form-item label="旋转角度（度数）：">
          <el-slider v-model="paraPacket.para2" show-input :max="360" :step="1"></el-slider>
        </el-form-item>
        <el-form-item label="缩放倍数：">
          <el-slider v-model="paraPacket.para3" show-input :max="2" :step="0.1"></el-slider>
        </el-form-item>
      </el-form>
      <div align="center">
        <el-button
  ...
  data(){
    return{
      paraPacket: {
        ...
        stype: '3025',
        img1: 'img1', img2: '',
        para1: '540,960', para2: 45, para3: 1, para4: '', para5: '', para6: '', para7: '', para8: '',
        status: '处理中'
      },
