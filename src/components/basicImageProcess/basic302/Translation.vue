  ...
  <div class="clock">
    ...
    <div>
      <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
        ...
        <el-form-item label="横轴平移：">
          <el-slider v-model="paraPacket.para1" show-input :max="3840" :step="1"></el-slider>
        </el-form-item>
        <el-form-item label="纵轴平移：">
          <el-slider v-model="paraPacket.para2" show-input :max="2160" :step="1"></el-slider>
        </el-form-item>
      </el-form>
      <div align="center">
        <el-button
...
export default {
  ...
  data(){
    return{
      paraPacket: {
        ...
        stype: '3022',
        img1: 'img1', img2: '',
        para1: 100, para2: 100, para3: '', para4: '', para5: '', para6: '', para7: '', para8: '',
        status: '处理中'
      },
  ...
  methods: {
    ...
    async post_para() {
      ...
      // post parameter
      await this.$axios
          .post('/translation',this.paraPacket)
          .then((res) => {
            console.log(res)
