  ...
  <div class="clock">
    ...
    <div>
      <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
        ...
        <el-form-item label="去噪类型：">
          <el-select v-model="paraPacket.para1" placeholder="请选择去噪类型">
            <el-option label="算术均值" value="1"></el-option>
            <el-option label="几何均值" value="2"></el-option>
            <el-option label="最大值" value="3"></el-option>
            <el-option label="高斯滤波" value="4"></el-option>
            <el-option label="中值滤波" value="5"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
      <div align="center">
...
export default {
  ...
  methods: {
    ...
    async post_para() {
      ...
      // post parameter
      await this.$axios
          .post('/remove_noise',this.paraPacket)
          .then((res) => {
            console.log(res)
