  ...
  <div class="clock">
    ...
    <div>
      <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
        ...
        <el-form-item label="生长中心坐标：">
          <el-input v-model="paraPacket.para1"></el-input>
        </el-form-item>
        <el-form-item label="同类门限值：">
          <el-slider v-model="paraPacket.para2" show-input :max="20" :step="1"></el-slider>
        </el-form-item>
        <el-form-item label="邻域类型：">
          <el-select v-model="paraPacket.para3" placeholder="请选择邻域类型">
            <el-option label="八邻域" value="1"></el-option>
            <el-option label="四邻域" value="0"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
      <div align="center">
...
export default {
  ...
  data(){
    return{
      paraPacket: {
        ...
        stype: '3031',
        img1: 'img1', img2: '',
        para1: '540,960', para2: 2, para3: '', para4: '', para5: '', para6: '', para7: '', para8: '',
        status: '处理中'
      },
  ...
  methods: {
    ...
    async post_para() {
      ...
      // post parameter
      await this.$axios
          .post('/region_grow',this.paraPacket)
          .then((res) => {
            console.log(res)
