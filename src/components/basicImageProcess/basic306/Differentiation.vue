    ...
    <div>
      <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
        ...
        <el-form-item label="阈值：">
          <el-slider v-model="paraPacket.para1" show-input :max="255" :step="1"></el-slider>
        </el-form-item>
      </el-form>
      <div align="center">
        <el-button
...
export default {
  ...
  data(){
    return{
      paraPacket: {
        ...
        stype: '3062',
        img1: 'img1', img2: '',
        para1: 100, para2: '', para3: '', para4: '', para5: '', para6: '', para7: '', para8: '',
        status: '处理中'
      },
  ...
  methods: {
    ...
    async post_para() {
      ...
      // post parameter
      await this.$axios
          .post('/differentiation',this.paraPacket)
          .then((res) => {
            console.log(res)
