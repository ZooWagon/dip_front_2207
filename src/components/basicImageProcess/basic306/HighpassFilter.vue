    ...
    <div>
      <el-form ref="para-form" :model="paraPacket" class="register-container" label-width="200px">
        ...
        <el-form-item label="滤波器类型：">
          <el-select v-model="paraPacket.para1" placeholder="请选择滤波器类型">
            <el-option label="理想高通滤波" value="1"></el-option>
            <el-option label="巴特沃斯高通滤波" value="2"></el-option>
            <el-option label="指数高通滤波" value="3"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="阈值：">
          <el-slider v-model="paraPacket.para2" show-input :max="255" :step="1"></el-slider>
        </el-form-item>
      </el-form>
      <div align="center">
        <el-button
...
export default {
  ...
  data(){
    return{
      paraPacket: {
        ...
        stype: '3061',
        img1: 'img1', img2: '',
        para1: '', para2: 100, para3: '', para4: '', para5: '', para6: '', para7: '', para8: '',
        status: '处理中'
      },
  ...
  methods: {
    ...
    async post_para() {
      ...
      // post parameter
      await this.$axios
          .post('/highpass_filter',this.paraPacket)
          .then((res) => {
            console.log(res)
